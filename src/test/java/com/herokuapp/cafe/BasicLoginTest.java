...
/*        @Test(priority = 2) public void createEmployee() throws InterruptedException {
        ...
        @Test(priority = 3) public void editByDoubleClick() throws InterruptedException {
            driver.findElement(createEmployeeButton).click();
            fillEmployeeData(firstName, lastName, startDate, email);
            driver.findElement(addEmployeeButton).click();
        ...
        @Test(priority = 4) public void editByButtonClick() throws InterruptedException {
            driver.findElement(createEmployeeButton).click();
            fillEmployeeData(firstName, lastName, startDate, email);
            driver.findElement(addEmployeeButton).click();
            (searchUser(firstName, lastName)).click();
        ...
        @Test(priority = 5) public void deleteEmployee() throws InterruptedException {
            WebElement user = searchUser(firstName, lastName);
            Actions action = new Actions(driver);
            action.doubleClick(user).build().perform();
            driver.findElement(deleteEmployeeButton).click();
            Assert.assertEquals("Are you sure you want to delete " + firstName + " " + lastName + "?",
                    driver.switchTo().alert().getText());
            driver.switchTo().alert().accept();
            //Assert.assertEquals("http://cafetownsend-angular-rails.herokuapp.com/employees", driver.getCurrentUrl());
        }

        @Test(priority = 6) public void logoutEmployee() throws InterruptedException {
            Thread.sleep(2000);
            Assert.assertEquals("http://cafetownsend-angular-rails.herokuapp.com/employees", driver.getCurrentUrl());
    ...
    @AfterMethod public void tearDownSession() {
        driver.quit();
    }*/
}
